...
export default function ContactPage() {
  return (
    <main className="max-w-6xl mx-auto px-4 py-8 pb-16">
      <h1 className="text-2xl font-bold text-black text-center mb-6">Contact Us</h1>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 md:p-8">
          <form className="space-y-4">
            ...
            <div>
              <label htmlFor="inquiry-type" className="block text-sm font-medium text-black mb-1">
                Inquiry Type
              </label>
              <select
                id="inquiry-type"
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="newsletter" className="ml-2 block text-sm text-black">
          ...
          <div className="mt-8 pt-6 border-t border-[#e5c1c4]">
            <h3 className="text-lg font-bold text-black mb-4">Connect With Us</h3>
            <div className="flex space-x-4">
              <Link
                href="https://instagram.com/luxe.essentials.co"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center text-black hover:text-[#D9A5B3]"
              >
